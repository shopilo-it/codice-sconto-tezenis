#!/usr/bin/env python3
"""
Recupero codici sconto Tezenis da shopilo.it
Sursa: https://shopilo.it/negozi/tezenis.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/tezenis.com"
STORE_NAME = "Tezenis"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Tezenis da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-tezenis)"
    }
    try:
