 ...
 * Homepage: https://shopilo.it/negozi/tezenis.com
 */

const SHOPILO_URL = "https://shopilo.it/negozi/tezenis.com";
const STORE_NAME  = "Tezenis";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-tezenis)" }
  });
